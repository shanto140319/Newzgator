...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: "node node_modules/next/dist/bin/next start -p 3100", url: "http://localhost:3100", env: { ARTICLE_API_BASE_URL: "http://localhost:4100", NEXT_PUBLIC_ARTICLE_API_BASE_URL: "http://localhost:4100", SITE_URL: "http://localhost:3100" } },
  ],
});
